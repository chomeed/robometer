...
CUDA_VISIBLE_DEVICES=0 uv run python train.py \
  ...
  custom_eval.reward_alignment_max_plots_successful=5 \
  custom_eval.reward_alignment_max_plots_failure=null \
  custom_eval.policy_ranking_max_tasks=1 \
  logging.save_best.metric_names=[eval_rew_align/pearson_board_insertion_test,eval_p_rank/kendall_last_board_insertion_test] \
